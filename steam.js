...
exports.run = (client, message, args) => {
    ...
    if (!game) return message.reply('***Please write the name of a game with Steam***')
  ...
  .setColor("#36393F")
    ...
    .addField('***Price***', `Normal price **${results.priceData.initialPrice}** TL
    Discounted price  **${results.priceData.finalPrice}** TL`, true)
